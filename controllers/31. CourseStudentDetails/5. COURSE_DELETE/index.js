...
const COURSE_DELETE_STUDENT_DETAILS = async (req , res) => {
    try 
    {
        ...
        await deleteData(`course_student_details`, { id: parseInt(id)}, res)
...
module.exports = COURSE_DELETE_STUDENT_DETAILS